...
export function * loadDataSaga () {
	    try {
		    const data = yield call(fetchPatterns);//fetch('https://gist.githubusercontent.com/ghajl/d873bcb8d32128b32618c7468dc6ca43/raw/0b4862bb8e1245a263d0c36802c9c0864321f13d/patterns.json').then(res => re.json());
		    // console.log(data);
