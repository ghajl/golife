...
class About extends Component {
  constructor(props){
    super(props);
      ...
      Object.keys(samples).forEach(name => {
        ...
        const board = unwrapped ? new UnwrappedGame(width, height, this.squareSize, cells, padding) : new Game(width, height, this.squareSize, cells);
        this.samples[name] = {
          board,
          label,
          width, 
  ...
  renderSampleWidthPredefined = name => {
  ...
  renderSampleWithoutButton = name => {
    const {label, canvasWidth} = this.samples[name];
    return (
      <BoardElement 
        key={name}
  ...
  createBoardElement(name) {
    const element = {
      beacon: this.renderSampleWithButton,
      beehive: this.renderSampleWithoutButton,
      blinker: this.renderSampleWithButton,
      block: this.renderSampleWithoutButton,
      boat: this.renderSampleWithoutButton,
      glider: this.renderSampleWithButton,
      gun: this.renderSampleWidthPredefined,
      loaf: this.renderSampleWithoutButton,
      spaceship: this.renderSampleWithButton,
      glasses: this.renderSampleWithButton,
      quad: this.renderSampleWithButton,
      toad: this.renderSampleWithButton,
    }
